...
(function (window, document, Laya) {
	...
	var Animation = laya.display.Animation,
	    ...
	    ClassUtils = laya.utils.ClassUtils,
	...
	var Ease = laya.utils.Ease,
	    ...
	    Font = laya.display.css.Font;
	var FrameAnimation = laya.display.FrameAnimation,
	...
	var Tween = laya.utils.Tween,
	    ...
	    WeakObject = laya.utils.WeakObject;
 ...
 */
	...
	var LayoutStyle = function () {
		...
		__static(LayoutStyle, ['EMPTY', function () {
			return this.EMPTY = new LayoutStyle();
		}]);
		return LayoutStyle;
	}();
 ...
 */
	...
	var Styles = function () {
		...
		__static(Styles, ['defaultSizeGrid', function () {
 ...
 */
	...
	var UIUtils = function () {
		...
		__static(UIUtils, ['grayFilter', function () {
			return this.grayFilter = new ColorFilter([0.3086, 0.6094, 0.082, 0, 0, 0.3086, 0.6094, 0.082, 0, 0, 0.3086, 0.6094, 0.082, 0, 0, 0, 0, 0, 1, 0]);
		}, 'escapeSequence', function () {
			return this.escapeSequence = { "\\n": "\n", "\\t": "\t" };
		}, '_funMap', function () {
			return this._funMap = new WeakObject();
		}]);
		return UIUtils;
	}();
 ...
 */
  ...
  */
		...
		__proto.drawBitmap = function (repeat, tex, x, y, width, height) {
			...
			if (repeat && (tex.width != width || tex.height != height)) this.fillTexture(tex, x, y, width, height);else this.drawTexture(tex, x, y, width, height);
		};
 ...
 */
  ...
  */
		__proto.close = function (dialog, type, showEffect) {
			showEffect === void 0 && (showEffect = false);
			if (showEffect && dialog.closeEffect != null) dialog.closeEffect.runWith([dialog, type]);else this.doClose(dialog, type);
	...
	var Box = function (_super) {
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			...
			for (var name in value) {
				...
				if (comp) comp.dataSource = value[name];else if (this.hasOwnProperty(name) && !(typeof this[name] == 'function')) this[name] = value[name];
			}
		});
 ...
 */
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'number' || typeof value == 'string') this.label = value + "";else Laya.superSet(Component, this, 'dataSource', value);
		});
		...
		__static(Button, ['stateMap', function () {
 ...
 */
  ...
  */
		...
		__proto._onDisplay = function (e) {
			if (this._isPlaying) {
				if (this._displayedInStage) this.play();else this.stop();
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'number' && Math.floor(value) == value || typeof value == 'string') this.index = parseInt(value);else Laya.superSet(Component, this, 'dataSource', value);
		});
 ...
 */
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'number' && Math.floor(value) == value || typeof value == 'string') this.selectedIndex = parseInt(value);else if (value instanceof Array) this.labels = value.join(",");else Laya.superSet(Component, this, 'dataSource', value);
		});
 ...
 */
  ...
  */
		...
		__proto.resetButtonPosition = function () {
			if (this.slider.isVertical) this.downButton.y = this.slider.y + this.slider.height;else this.downButton.x = this.slider.x + this.slider.width;
		};
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'number' || typeof value == 'string') this.value = Number(value);else Laya.superSet(Component, this, 'dataSource', value);
		});
 ...
 */
  ...
  */
		__proto.mouseMove = function (e) {
			...
			if (this.isVertical) {
				...
				if (this._bar.y > this._maxMove) this._bar.y = this._maxMove;else if (this._bar.y < 0) this._bar.y = 0;
				...
				if (this._bar.x > this._maxMove) this._bar.x = this._maxMove;else if (this._bar.x < 0) this._bar.x = 0;
  ...
  */
		__getset(0, __proto, 'allowClickBack', function () {
			...
			if (this._allowClickBack != value) {
				...
				if (value) this._bg.on( /*laya.events.Event.MOUSE_DOWN*/"mousedown", this, this.onBgMouseDown);else this._bg.off( /*laya.events.Event.MOUSE_DOWN*/"mousedown", this, this.onBgMouseDown);
			}
		});
  ...
  */
		...
		__static(Slider, ['label', function () {
 ...
 */
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'string') this.skin = value;else Laya.superSet(Component, this, 'dataSource', value);
		});
 ...
 */
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'number' || typeof value == 'string') this.text = value + "";else Laya.superSet(Component, this, 'dataSource', value);
		});
  ...
  */
		...
		View.createComp = function (uiView, comp, view, dataMap) {
			...
			for (var prop in props) {
				...
				} else View.setCompValue(comp, prop, value, view, dataMap);
			}
		...
		View.viewClassMap = {};
		View._sheet = null;
		__static(View, ['uiClassMap', function () {
			...
			return this.eventDic = { "mousedown": true, "mouseup": true, "mousemove": true, "mouseover": true, "mouseout": true, "click": true, "doubleclick": true, "rightmousedown": true, "rightmouseup": true, "rightclick": true };
 ...
 */
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'boolean') this.selected = value;else if (typeof value == 'string') this.selected = value === "true";else Laya.superSet(Button, this, 'dataSource', value);
		});
  ...
  */
		...
		__proto.changeValue = function () {
			...
			for (var i = 0, sz = this._valueArr.length; i < sz; i++) {
				...
				if (isHorizontal) this.graphics.drawTexture(texture, dX + i * (texture.sourceWidth + this.spaceX), 0, texture.sourceWidth, texture.sourceHeight);else this.graphics.drawTexture(texture, 0 + dX, i * (texture.sourceHeight + this.spaceY), texture.sourceWidth, texture.sourceHeight);
			}
			if (!this._width) {
				this.resetLayoutX();
				this.callLater(this.changeSize);
 ...
 */
  ...
  */
		__proto.changeCells = function () {
			...
			if (this._itemRender) {
				...
				if (this._isVertical && this._scrollBar) this._scrollBar.height = listHeight;else if (!this._isVertical && this._scrollBar) this._scrollBar.width = listWidth;
  ...
  */
		...
		__getset(0, __proto, 'cacheAs', _super.prototype._$get_cacheAs, function (value) {
			...
			if (this._scrollBar) {
				...
				if (value !== "none") this._scrollBar.on( /*laya.events.Event.START*/"start", this, this.onScrollStart);else this._scrollBar.off( /*laya.events.Event.START*/"start", this, this.onScrollStart);
			}
		});
  ...
  */
		__getset(0, __proto, 'vScrollBarSkin', function () {
			...
			scrollBar.right = 0;
			if (value && value != " ") scrollBar.skin = value;
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'number' && Math.floor(value) == value || typeof value == 'string') this.selectedIndex = parseInt(value);else if (value instanceof Array) this.array = value;else Laya.superSet(Box, this, 'dataSource', value);
		});
 ...
 */
  ...
  */
		...
		__getset(0, __proto, 'dataSource', _super.prototype._$get_dataSource, function (value) {
			this._dataSource = value;
			if (typeof value == 'number' && Math.floor(value) == value || typeof value == 'string') this.selectedIndex = parseInt(value);else if (value instanceof Array) this.labels = value.join(",");else Laya.superSet(Box, this, 'dataSource', value);
		});
 ...
 */
	...
	var AsynDialog = function (_super) {
		...
		__proto._open = function (modal, closeOther, showEffect) {
			...
			if (this._uiView) this.onCreated();else this.onOpen();
		};
