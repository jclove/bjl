...
(function (window, document, Laya) {
	...
	var Component3D = laya.d3.component.Component3D,
	    ComponentNode = laya.d3.core.ComponentNode,
	    MeshTerrainSprite3D = laya.d3.core.MeshTerrainSprite3D;
 ...
 */
  ...
  */
		__proto._load = function (owner) {
			if (!(owner instanceof laya.d3.core.MeshTerrainSprite3D)) throw new Error("PathFinding: The owner must MeshTerrainSprite3D!");
