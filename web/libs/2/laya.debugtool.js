...
(function (window, document, Laya) {
	...
	var Box = laya.ui.Box,
	    ...
	    CSSStyle = laya.display.css.CSSStyle;
	var Component = laya.ui.Component,
	    Config = Laya.Config,
	    Event = laya.events.Event,
	    EventDispatcher = laya.events.EventDispatcher;
	var Filter = laya.filters.Filter,
	    GrahamScan = laya.maths.GrahamScan,
	    Graphics = laya.display.Graphics,
	    HTMLCanvas = laya.resource.HTMLCanvas;
	...
	var List = laya.ui.List,
	    ...
	    LoaderManager = laya.net.LoaderManager,
	    LocalStorage = laya.net.LocalStorage;
	var MathUtil = laya.maths.MathUtil,
	    Matrix = laya.maths.Matrix,
	    Node = laya.display.Node,
	    Point = laya.maths.Point,
	    Pool = laya.utils.Pool;
	var Rectangle = laya.maths.Rectangle,
	    Render = laya.renders.Render,
	    RenderContext = laya.renders.RenderContext,
	    RenderSprite = laya.renders.RenderSprite;
	var Resource = laya.resource.Resource,
	    ResourceManager = laya.resource.ResourceManager,
	    RunDriver = laya.utils.RunDriver;
	var Sprite = laya.display.Sprite,
	    Stage = laya.display.Stage,
	    Stat = laya.utils.Stat,
	    Style = laya.display.css.Style;
	var Text = laya.display.Text,
	    TextInput = laya.ui.TextInput,
	    Texture = laya.resource.Texture,
	    Timer = laya.utils.Timer;
	var Tree = laya.ui.Tree,
	    UIEvent = laya.ui.UIEvent,
	    URL = laya.net.URL,
 ...
 */
	...
	var DebugPanel = function () {
		...
		DebugPanel.tObjKeys = [];
		__static(DebugPanel, ['displayTypes', function () {
			return this.displayTypes = { "boolean": true, "number": true, "string": true };
			...
			return this.noDisplayKeys = { "desginWidth": true, "desginHeight": true };
		}]);
		return DebugPanel;
	}();
 ...
 */
  ...
  */
		...
		__static(DebugTool, ['text', function () {
			return this.text = new Stat();
		}, 'cmdToTypeO', function () {
			return this.cmdToTypeO = {};
		}, 'counter', function () {
			return this.counter = new CountTool();
		}, 'nameFilter', function () {
			return this.nameFilter = { "name": "name" };
		}]);
		return DebugTool;
	}();
 ...
 */
	...
	var CacheAnalyser = function () {
		...
		__static(CacheAnalyser, ['counter', function () {
			return this.counter = new ObjTimeCountTool();
		}, 'I', function () {
			return this.I = new CacheAnalyser();
		}]);
 ...
 */
	...
	var ClassTool = function () {
		...
		__static(ClassTool, ['displayTypes', function () {
			return this.displayTypes = { "boolean": true, "number": true, "string": true };
		}]);
		return ClassTool;
	}();
 ...
 */
	...
	var DebugExport = function () {
		...
		__static(DebugExport, ['_exportsDic', function () {
 ...
 */
	...
	var DisController = function () {
		...
		__static(DisController, ['I', function () {
			return this.I = new DisController();
		}]);
 ...
 */
	...
	var DisControlTool = function () {
		...
		DisControlTool.getObjectsUnderPoint = function (sprite, x, y, rst, filterFun) {
			...
			if (sprite.getBounds().contains(x, y)) {
				...
				for (var i = sprite._childs.length - 1; i > -1; i--) {
					...
					if (child instanceof laya.display.Sprite) DisControlTool.getObjectsUnderPoint(child, x, y, rst, filterFun);
				}
			}
			return rst;
		};
		...
		__static(DisControlTool, ['tempP', function () {
			return this.tempP = new Point();
		}]);
 ...
 */
	...
	var ClassCreateHook = function () {
		...
		__static(ClassCreateHook, ['I', function () {
			return this.I = new ClassCreateHook();
		}]);
 ...
 */
	...
	var FunctionTimeHook = function () {
		...
		FunctionTimeHook.hookFun = function (obj, funName) {
			...
			var timePreFun = function timePreFun(__args) {
				var args = arguments;
				FunctionTimeHook.funBegin(myKey);
			};
			var timeEndFun = function timeEndFun(__args) {
				var args = arguments;
		...
		__static(FunctionTimeHook, ['counter', function () {
			return this.counter = new CountTool();
		}]);
 ...
 */
  ...
  */
		...
		__proto.analyseNode = function (node) {
			...
			if (!SpriteRenderForVisibleAnalyse.tarCanvas) SpriteRenderForVisibleAnalyse.tarCanvas = CanvasTools.createCanvas(Laya.stage.width, Laya.stage.height);
			if (!SpriteRenderForVisibleAnalyse.mainCanvas) SpriteRenderForVisibleAnalyse.mainCanvas = CanvasTools.createCanvas(Laya.stage.width, Laya.stage.height);
			this.isTargetRenderd = false;
 ...
 */
	...
	var GetSetProfile = function () {
		...
		__static(GetSetProfile, ['noDisplayKeys', function () {
			return this.noDisplayKeys = { "conchModel": true };
		}]);
 ...
 */
	...
	var FunHook = function () {
		...
		__static(FunHook, ['special', function () {
			return this.special = _defineProperty({
				"length": true,
				"name": true,
				"arguments": true,
				"caller": true,
 ...
 */
	...
	var IDTools = function () {
		...
		__static(IDTools, ['_ID', function () {
			return this._ID = new IDTools();
		}, '_idDic', function () {
			return this._idDic = { "default": new IDTools() };
		}]);
		return IDTools;
	}();
 ...
 */
	...
	var JsonTool = function () {
		...
		JsonTool.emptyDic = {};
		__static(JsonTool, ['singleLineKey', function () {
 ...
 */
	...
	var MouseEventAnalyser = function () {
		...
		__static(MouseEventAnalyser, ['_matrix', function () {
			return this._matrix = new Matrix();
		}, '_point', function () {
			return this._point = new Point();
		}, '_rect', function () {
			return this._rect = new Rectangle();
		}]);
 ...
 */
	...
	var RenderAnalyser = function () {
		...
		__static(RenderAnalyser, ['I', function () {
			return this.I = new RenderAnalyser();
		}]);
 ...
 */
	...
	var SimpleResizer = function () {
		...
		__static(SimpleResizer, ['preMousePoint', function () {
			return this.preMousePoint = new Point();
		}, 'preTarSize', function () {
			return this.preTarSize = new Point();
		}, 'preScale', function () {
			return this.preScale = new Point();
		}]);
		...
		ResTools.getWebGlResList = function () {
			...
			for (var i = 0; i < _resources.length; i++) {
				...
				if (ClassTool.getClassName(tResource) == "WebGLImage") {
					...
					if (url && url.indexOf("data:image/png;base64") < 0) rst.push(url);
				}
			}
			return rst;
		};
 ...
 */
	...
	var SingleTool = function () {
		...
		__static(SingleTool, ['I', function () {
			return this.I = new SingleTool();
		}]);
		return SingleTool;
	}();
 ...
 */
	...
	var StringTool = function () {
		...
		StringTool.removeCommentLine = function (lines) {
			...
			while (i < len) {
				...
				if (index >= 0) {
					...
					if (laya.debug.tools.StringTool.trim(tLine).indexOf("//") == 0) {} else {
						StringTool.addIfNotEmpty(rst, adptLine);
					}
				} else {
					StringTool.addIfNotEmpty(rst, adptLine);
		...
		__static(StringTool, ['emptyStrDic', function () {
			...
			return this.specialChars = { "*": true, "&": true, "%": true, "#": true, "?": true };
		}]);
		return StringTool;
	}();
	...
	var TimerControlTool = function () {
		...
		TimerControlTool.setTimeRate = function (rate) {
			...
			if (rate != 1) {
				...
				if (TimerControlTool._browerNow != null) Browser["now"] = TimerControlTool._browerNow;
			}
		};
 ...
 */
	...
	var VisibleAnalyser = function () {
		...
		VisibleAnalyser.anlyseRecVisible = function (node) {
			...
			if (!VisibleAnalyser.mainCanvas) VisibleAnalyser.mainCanvas = CanvasTools.createCanvas(Laya.stage.width, Laya.stage.height);
		...
		__static(VisibleAnalyser, ['tarRec', function () {
			return this.tarRec = new Rectangle();
		}, 'interRec', function () {
			return this.interRec = new Rectangle();
		}]);
 ...
 */
	...
	var NodeUtils = function () {
		...
		NodeUtils.getGRec = function (node) {
			...
			if (!pointList || pointList.length < 1) return Rectangle.TEMP.setTo(0, 0, 0, 0);
			pointList = GrahamScan.pListToPointList(pointList, true);
		...
		NodeUtils.g = null;
		__static(NodeUtils, ['defaultKeys', function () {
 ...
 */
	...
	var StyleConsts = function () {
		...
		__static(StyleConsts, ['PanelScale', function () {
			return this.PanelScale = Browser.onPC ? 1 : Browser.pixelRatio;
		}]);
		return StyleConsts;
	}();
 ...
 */
	...
	var Notice = function (_super) {
		...
		__static(Notice, ['I', function () {
			return this.I = new Notice();
		}]);
		return Notice;
	}(EventDispatcher);
 ...
 */
	...
	var ColorSelector = function (_super) {
		...
		__proto.updateDemoColor = function (notice) {
			...
			if (notice) this.event("ColorChanged", this);
		};
 ...
 */
	...
	var NodeInfosItem = function (_super) {
		...
		NodeInfosItem._txts = [];
		__static(NodeInfosItem, ['showValues', function () {
			return this.showValues = ["x", "y", "scaleX", "scaleY", "width", "height", "visible", "mouseEnabled"];
		}, '_disBoundRec', function () {
			return this._disBoundRec = new Rectangle();
		}, '_nodePoint', function () {
			return this._nodePoint = new Point();
		}]);
 ...
 */
	...
	var NodeRecInfo = function (_super) {
		...
		__static(NodeRecInfo, ['_disBoundRec', function () {
			return this._disBoundRec = new Rectangle();
		}]);
		return NodeRecInfo;
	}(Sprite);
 ...
 */
	...
	var ToolPanel = function (_super) {
		...
		ToolPanel.Tree = "Tree";
		__static(ToolPanel, ['typeClassDic', function () {
 ...
 */
	...
	var CacheRankView = function (_super) {
		...
		__getset(1, CacheRankView, 'I', function () {
			if (!CacheRankView._I) CacheRankView._I = new CacheRankView();
 ...
 */
	...
	var DebugPanelView = function (_super) {
		...
		__static(DebugPanelView, ['tempPos', function () {
			return this.tempPos = new Point();
		}]);
 ...
 */
	...
	var NodeListPanelView = function (_super) {
		...
		__getset(1, NodeListPanelView, 'I', function () {
			if (!NodeListPanelView._I) NodeListPanelView._I = new NodeListPanelView();
 ...
 */
	...
	var NodeToolView = function (_super) {
		...
		__proto.showByNode = function (node, ifShow) {
			...
			if (ifShow) _super.prototype.show.call(this);
			this._tar = node;
			this.fresh();
		};
		...
		__static(NodeToolView, ['tempPos', function () {
			return this.tempPos = new Point();
		}]);
		return NodeToolView;
	}(UIViewBase);
 ...
 */
	...
	var ObjectCreateView = function (_super) {
		...
		__proto.fresh = function () {
			...
			var count;
			for (key in dataO) {
				if (!this.preInfo[key]) this.preInfo[key] = 0;
				tData = {};
				tData.path = key;
		...
		__getset(1, ObjectCreateView, 'I', function () {
			if (!ObjectCreateView._I) ObjectCreateView._I = new ObjectCreateView();
 ...
 */
	...
	var RenderCostRankView = function (_super) {
		...
		__getset(1, RenderCostRankView, 'I', function () {
			if (!RenderCostRankView._I) RenderCostRankView._I = new RenderCostRankView();
 ...
 */
	...
	var ResRankView = function (_super) {
		...
		__getset(1, ResRankView, 'I', function () {
			if (!ResRankView._I) ResRankView._I = new ResRankView();
 ...
 */
	...
	var SelectInfosView = function (_super) {
		...
		__proto.onFliterTxtChange = function (e) {
			...
			} else if (key != this.showKeys.join(",")) {
 ...
 */
	...
	var CodeUsedResUI = function (_super) {
		...
		__static(CodeUsedResUI, ['uiView', function () {
			return this.uiView = { "type": "View", "child": [{ "props": { "x": 359, "y": 91, "skin": "comp/button1.png" }, "type": "Image" }, { "props": { "x": 309, "y": 283, "skin": "comp/line2.png" }, "type": "Image" }, { "type": "Tab", "child": [{ "props": { "skin": "view/create.png", "label": "  对象创建", "width": 70, "height": 17, "name": "item0" }, "type": "CheckBox" }, { "props": { "x": 70, "skin": "view/rendertime.png", "label": "渲染用时", "width": 70, "height": 19, "name": "item1" }, "type": "CheckBox" }, { "props": { "x": 140, "skin": "view/cache.png", "label": "Cache", "width": 70, "height": 16, "name": "item2" }, "type": "CheckBox" }], "props": { "x": 76, "y": 210, "selectedIndex": 0, "var": "tab" } }], "props": { "width": 600, "height": 400, "base64pic": true } };
		}]);
	...
	var RankListItemUI = function (_super) {
		...
		__proto.viewMapRegists = function () {};
		__static(RankListItemUI, ['uiView', function () {
			return this.uiView = { "type": "View", "child": [{ "props": { "y": -1, "skin": "comp/clip_selectBox.png", "clipY": 2, "height": 19, "name": "selectBox", "left": 0, "right": 0, "x": 0 }, "type": "Clip" }, { "props": { "text": "render", "color": "#a0a0a0", "height": 15, "name": "label", "y": 2, "left": 11, "right": 5, "fontSize": 12, "x": 11, "width": 163 }, "type": "Label" }], "props": { "width": 179, "height": 19 } };
		}]);
	...
	var MinBtnCompUI = function (_super) {
		...
		__proto.viewMapRegists = function () {};
		__static(MinBtnCompUI, ['uiView', function () {
			return this.uiView = { "type": "View", "child": [{ "props": { "x": 7, "y": 8, "skin": "comp/minBtn.png", "stateNum": "3", "var": "minBtn", "width": 22, "height": 20, "toolTip": "最小化" }, "type": "Button" }, { "type": "Box", "child": [{ "props": { "x": 0, "y": 0, "skin": "view/bg_panel.png", "var": "bg", "width": 36, "height": 36, "sizeGrid": "5,5,5,5" }, "type": "Image" }, { "props": { "x": 6, "y": 8, "skin": "view/zoom_out.png", "stateNum": "2", "var": "maxBtn" }, "type": "Button" }], "props": { "var": "maxUI" } }], "props": { "width": 36, "height": 36, "base64pic": true } };
		}]);
		return MinBtnCompUI;
	}(View);
 ...
 */
  ...
  */
		...
		__static(NodeTree, ['showKeys', function () {
