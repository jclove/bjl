...
!function (t, i, e) {
  e.un, e.uns;var s = e.static,
      ...
      w = laya.utils.Tween,
      x = laya.utils.Utils,
      B = laya.utils.WeakObject;e.interface("laya.ui.IItem"), e.interface("laya.ui.ISelect"), e.interface("laya.ui.IRender"), e.interface("laya.ui.IComponent"), e.interface("laya.ui.IBox", "IComponent");var k = function () {
    function t() {
    ...
    function i() {
      ...
      this._isChanged = !1;var t = this._source;if (t && t.bitmap) {
        var e = this.width,
          ...
          t.$_GID || (t.$_GID = x.getGID());var r = t.$_GID + "." + e + "." + s + "." + h.join(".");if (x.isOKCmdList(B.I.get(r))) return void (this.cmds = B.I.get(r));this.clear();var l = h[0],
              a = h[1],
              c = h[2],
              u = h[3],
              _ = h[4],
      ...
      s <= 0 && (s = 1), h <= 0 && (h = 1), t.$_GID || (t.$_GID = x.getGID());var n = t.$_GID + "." + i + "." + e + "." + s + "." + h,
          o = B.I.get(n);return o && o.source || (o = S.createFromTexture(t, i, e, s, h), B.I.set(n, o)), o;
    }, i;
  }(d),
      T = (function (t) {
    function i() {
    ...
    function i() {
      this.lockLayer = null, this.popupEffect = function (t) {
        t.scale(1, 1), w.from(t, { x: e.stage.width / 2, y: e.stage.height / 2, scaleX: 0, scaleY: 0 }, 300, a.backOut, f.create(this, this.doOpen, [t]));
      }, this.closeEffect = function (t, i) {
        w.to(t, { x: e.stage.width / 2, y: e.stage.height / 2, scaleX: 0, scaleY: 0 }, 300, a.strongOut, f.create(this, this.doClose, [t, i]));
    ...
    }h(i, "laya.ui.DialogManager", C);var s = i.prototype;return s._closeOnSide = function () {
      ...
      var i = this.maskLayer.width = e.stage.width,
          s = this.maskLayer.height = e.stage.height;this.lockLayer && this.lockLayer.size(i, s), this.maskLayer.graphics.clear(), this.maskLayer.graphics.drawRect(0, 0, i, s, M.popupBgColor), this.maskLayer.alpha = M.popupBgAlpha;for (var h = this.numChildren - 1; h > -1; h--) {
    ...
    function i(t, e) {
      ...
      var t = g.getRes(this._skin);if (t) {
        var i = t.sourceWidth,
            e = t.sourceHeight / this._stateNum;t.$_GID || (t.$_GID = x.getGID());var s = t.$_GID + "-" + this._stateNum,
            h = B.I.get(s);if (x.isOkTextureList(h) || (h = null), h) this._sources = h;else {
          if (this._sources = [], 1 === this._stateNum) this._sources.push(t);else for (var n = 0; n < this._stateNum; n++) {
            this._sources.push(S.createFromTexture(t, 0, e * n, i, e));
    ...
    function i(t, e, s) {
      ...
      if (this._clipChanged = !1, this._skin) {
        var t = g.getRes(this._skin);t ? this.loadComplete(this._skin, t) : e.loader.load(this._skin, f.create(this, this.loadComplete, [this._skin]));
      }
      ...
      if (t === this._skin && i) {
        var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX),
            ...
            h = this._skin + e + s,
            n = B.I.get(h);if (x.isOkTextureList(n) || (n = null), n) this._sources = n;else {
          this._sources = [];for (var o = 0; o < this._clipY; o++) {
            for (var r = 0; r < this._clipX; r++) {
              this._sources.push(S.createFromTexture(i, e * r, s * o, e, s));
            }
    ...
    function i(t, e) {
      ...
      if (this._isOpen != t) if (this._isOpen = t, this._button.selected = this._isOpen, this._isOpen) {
        this._list || this._createList(), this._listChanged && !this._isCustomList && this.changeList(), this._itemChanged && this.changeItem();var i = this.localToGlobal(m.TEMP.setTo(0, 0)),
            s = i.y + this._button.height;s = s + this._listHeight <= e.stage.height ? s : i.y - this._listHeight, this._list.pos(i.x, s), this._list.zOrder = 1001, e._currentStage.addChild(this._list), e.stage.once("mousedown", this, this.removeList), e.stage.on("mousewheel", this, this._onStageMouseWheel), this._list.selectedIndex = this._selectedIndex;
    ...
    function i(t) {
      ...
      var i = t.currentTarget === this.upButton;this.slide(i), e.timer.once(I.scrollBarDelayTime, this, this.startLoop, [i]), e.stage.once("mouseup", this, this.onStageMouseUp);
      ...
      if (e.stage.off("mouseup", this, this.onStageMouseUp2), e.stage.off("mouseout", this, this.onStageMouseUp2), e.timer.clear(this, this.loop), !(this._clickOnly && this._value >= this.min && this._value <= this.max)) if (this._target.mouseEnabled = !0, this._isElastic) this._value < this.min ? w.to(this, { value: this.min }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver)) : this._value > this.max && w.to(this, { value: this.max }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver));else {
      ...
      this._isElastic = !1, !this.hide && this.autoHide && w.to(this, { alpha: 0 }, 500), this.event("end");
      ...
      this._lastOffset *= this.rollRatio;var i = NaN;if (t > 0 && (this._lastOffset > 0 && this.value <= this.min ? (this._isElastic = !0, i = .5 * -(this.min - t - this.value), this._lastOffset > i && (this._lastOffset = i)) : this._lastOffset < 0 && this.value >= this.max && (this._isElastic = !0, i = .5 * -(this.max + t - this.value), this._lastOffset < i && (this._lastOffset = i))), this.value -= this._lastOffset, Math.abs(this._lastOffset) < 1) {
        if (e.timer.clear(this, this.tweenMove), this._isElastic) return void (this._value < this.min ? w.to(this, { value: this.min }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver)) : this._value > this.max ? w.to(this, { value: this.max }, this.elasticBackTime, a.sineOut, f.create(this, this.elasticOver)) : this.elasticOver());this.event("end"), !this.hide && this.autoHide && w.to(this, { alpha: 0 }, 500);
      }
    ...
    function i(t) {
      ...
      if (this._skin != t) if (this._skin = t, t) {
        var i = g.getRes(t);i ? (this.source = i, this.onCompResize()) : e.loader.load(this._skin, f.create(this, this.setSource, [this._skin]), null, "image", 1, !0, this._group);
    ...
    }h(i, "laya.ui.TipManager", T);var s = i.prototype;s._onStageHideTip = function (t) {
    ...
    function i() {
    ...
    }var n;h(i, "laya.ui.View", H);var l = i.prototype;return l.createView = function (t) {
      if (t.animations && !this._idMap && (this._idMap = {}), i.createComp(t, this, this), t.animations) {
        var e,
          ...
          switch (e = new _(), s = n[o], e._setUp(this._idMap, s), this[s.name] = e, e._setControlNode(this), s.action) {case 1:
      ...
      for (var t in i.uiClassMap) {
        r.regClass(t, i.uiClassMap[t]);
      }
    }, i.createComp = function (t, s, h, n) {
      if (!(s = s || i.getCompInstance(t))) return console.warn("can not create:" + t.type), null;var o = t.child;if (o) for (var l = s instanceof laya.ui.List, a = 0, c = o.length; a < c; a++) {
        var u = o[a];if (!s.hasOwnProperty("itemRender") || "render" != u.props.name && "render" !== u.props.renderType) {
          if ("Graphic" == u.type) r.addGraphicsToSprite(u, s);else if (r.isDrawType(u.type)) r.addGraphicToSprite(u, s, !0);else {
            if (l) {
              var _ = [],
        ...
        var g = f[p];i.eventDic[p] ? g && h && s.on(p, h, h.onEvent, [g]) : i.setCompValue(s, p, g, h, n);
      ...
      if ("string" == typeof h && h.indexOf("${") > -1) {
        if (i._sheet || (i._sheet = r.getClass("laya.data.Table")), !i._sheet) return void console.warn("Can not find class Sheet");if (l) l.push(t, s, h);else if (o) {
          -1 == h.indexOf("].") && (h = h.replace(".", "[0]."));var a = new n(t, s, h);a.exe(o);for (var c, u, _ = h.replace(/\[.*?\]\./g, "."); null != (c = i._parseWatchData.exec(_));) {
            for (var d = c[1]; null != (u = i._parseKeyWord.exec(d));) {
              var f = u[0],
                  p = o._watchMap[f] || (o._watchMap[f] = []);p.push(a), i._sheet.I.notifer.on(f, o, o.changeData, [f]);
            }(p = o._watchMap[d] || (o._watchMap[d] = [])).push(a), i._sheet.I.notifer.on(d, o, o.changeData, [d]);
          }
        }
      } else if ("var" === s && o) o[h] = t;else if ("onClick" == s) {
        var g = e._runScript("(function(){" + h + "})");t.on("click", o, g);
      ...
      return this.uiClassMap = { ViewStack: tt, LinkButton: N, TextArea: at, ColorPicker: A, Box: H, Button: N, CheckBox: W, Clip: O, ComboBox: Y, Component: T, HScrollBar: j, HSlider: Z, Image: V, Label: D, List: U, Panel: K, ProgressBar: G, Radio: J, RadioGroup: rt, ScrollBar: X, Slider: E, Tab: lt, TextInput: et, View: i, VScrollBar: it, VSlider: st, Tree: Q, HBox: nt, VBox: ot, Sprite: C, Animation: o, Text: b, FontClip: F };
    }, "eventDic", function () {
      return this.eventDic = { mousedown: !0, mouseup: !0, mousemove: !0, mouseover: !0, mouseout: !0, click: !0, doubleclick: !0, rightmousedown: !0, rightmouseup: !0, rightclick: !0 };
    ...
    }h(i, "laya.ui.LayoutBox", H);var e = i.prototype;return e.addChild = function (t) {
    ...
    function i() {
      ...
      var s = this._content,
        ...
        var r = new H();r.cacheAsBitmap = !0, r.pos((this._isVertical ? 0 : t) * n, (this._isVertical ? t : 0) * o), this._content.addChild(r), this._content.optimizeScrollRect = !0, s = r;
      } else {
      ...
      var t = [];if ("function" == typeof this._itemRender) var i = new this._itemRender();else i = R.createComp(this._itemRender, null, null, t);if (0 == t.length && i._watchMap) {
      ...
      if (void 0 === i && (i = 200), this._scrollBar) {
        var s = this._isVertical ? this.repeatX : this.repeatY;w.to(this._scrollBar, { value: Math.floor(t / s) * this._cellSize }, i, null, e, 0, !0);
      ...
      this._removePreScrollBar();var i = new it();i.name = "scrollBar", i.right = 0, t && " " != t && (i.skin = t), this.scrollBar = i, this.addChild(i), this._setCellChanged();
    }), n(0, s, "page", function () {
      return this._page;
    }, function (t) {
      ...
      this._removePreScrollBar();var i = new j();i.name = "scrollBar", i.bottom = 0, t && " " != t && (i.skin = t), this.scrollBar = i, this.addChild(i), this._setCellChanged();
    ...
    function i() {
      ...
      var e = this._content;e.width = t, e.height = i, e.scrollRect || (e.scrollRect = new y()), e.scrollRect.setTo(0, 0, t, i), e.scrollRect = e.scrollRect;
    }, s.onScrollBarChange = function (t) {
    ...
    function i(t, e) {
      ...
      this._items || (this._items = []), this._items.length = 0;for (var t = 0; t < 1e4; t++) {
        var i = this.getChildByName("item" + t);if (null == i) break;this._items.push(i), i.selected = t === this._selectedIndex, i.clickHandler = f.create(this, this.itemClick, [t], !1);
      }
    ...
    function i() {
      ...
      if (t) {
        var i = L.fillArray([0, 0, 0, 0], t, Number);this._dragArea = new y(i[0], i[1], i[2], i[3]), this.on("mousedown", this, this._onMouseDown);
    ...
    function i() {
      i.__super.call(this);
    }h(i, "laya.ui.RadioGroup", q);return i.prototype.createItem = function (t, i) {
      return new J(t, i);
    }, i;
  }(),
      lt = function (t) {
    function i() {
      i.__super.call(this);
    }h(i, "laya.ui.Tab", q);return i.prototype.createItem = function (t, i) {
      return new N(t, i);
    }, i;
  }(),
      at = function (t) {
    ...
    }h(i, "laya.ui.AsynDialog", ht);var e = i.prototype;e.createView = function (t) {
      this._uiView = t;
