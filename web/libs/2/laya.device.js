 ...
 */
	...
	var Video = function (_super) {
		function Video(width, height) {
			...
			if (Render.isWebGL) this.htmlVideo = new WebGLVideo();else this.htmlVideo = new HtmlVideo();
  ...
  */
		...
		__proto.renderCanvas = function () {
			...
			if (Render.isWebGL) this.htmlVideo['updateTexture']();
			this.graphics.clear();
