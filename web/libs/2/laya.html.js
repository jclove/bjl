 ...
 */
	...
	var Layout = function () {
		...
		Layout.layout = function (element) {
			...
			if ((element._style._type & /*laya.display.css.CSSStyle.ADDLAYOUTED*/0x200) === 0) return null;
 ...
 */
	...
	var HTMLDocument = function (_super) {
		...
		__static(HTMLDocument, ['document', function () {
			return this.document = new HTMLDocument();
		}]);
		return HTMLDocument;
	}(HTMLElement);
