...
(function (window, document, Laya) {
	...
	var Browser = laya.utils.Browser,
	    ...
	    ColorFilterAction = laya.filters.ColorFilterAction;
	var ColorFilterActionGL = laya.filters.webgl.ColorFilterActionGL,
	    Filter = laya.filters.Filter,
	    FilterActionGL = laya.filters.webgl.FilterActionGL;
	...
	var RenderTarget2D = laya.webgl.resource.RenderTarget2D,
	    ...
	    ShaderDefines2D = laya.webgl.shader.d2.ShaderDefines2D;
 ...
 */
	...
	var BlurFilterActionGL = function (_super) {
		...
		__getset(0, __proto, 'typeMix', function () {
			return (/*laya.filters.Filter.BLUR*/0x10
			);
		});
 ...
 */
	...
	var GlowFilterActionGL = function (_super) {
		...
		__getset(0, __proto, 'typeMix', function () {
			return (/*laya.filters.Filter.GLOW*/0x08
			);
		});
