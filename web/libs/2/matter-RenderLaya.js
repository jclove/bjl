...
(function () {
    var graphics, spriteCon, graphicsCon;
    ...
    function setBackground(render) {
        ...
        //  纯色背景
        if (bg.length == 7 && bg[0] == '#') {
            spriteCon.graphics.drawRect(0, 0, render.options.width, render.options.height, bg);
        }
        // 图片背景
        else {
    ...
    LayaRender.constraint = function (engine, constraint) {
        ...
        graphics.drawLine(sx, sy, ex, ey, constraint.render.strokeStyle, constraint.render.lineWidth);
    };
