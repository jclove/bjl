...
var betNum;
var GameBet = function GameBet() {
    GameBet.super(this);
    //颜色滤镜矩阵,灰色
    var _this = this;
    var colorMatrix = [0.2086, 0.7094, 0.0820, 0, 0, //R
    ...
    GameBet.prototype.init = function () {
        //页面初始化
        _this.btnRecall.zOrder = "999";
        colorInit();
        betNum = 10;
        _this.bet2.filters = null;
        for (var index = 0; index < _this.btnBetList.numChildren; index++) {
            //事件监听
    ...
    GameBet.prototype.OnBtnrecall = function (arr) {
        //点击撤销
    ...
    GameBet.prototype.transition = function (arr) {
        //选中注数
        colorInit();
    ...
    function colorInit() {
        //添加滤镜
        for (var index = 0; index < _this.btnBetList._childs.length; index++) {
