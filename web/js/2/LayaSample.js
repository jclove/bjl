...
var chongFlag = true;
// userData = {    //假的用户信息
//     "openId": "oGPD00JvsRYet7seFUPKzSKXwoKM",
//     "nickName": "bohan",
...
function baijialeInit(LayaSample) {
    ...
    function LoadImgFirst() {
        //首次加载，加载动画
        var resArray = [{ url: "res/atlas/loadfirst.json", type: Laya.Loader.ATLAS }];
    ...
    function onLoadEdfitsr() {
        ...
        LayaSample.socket.connectByUrl("ws://baijia.beetg.cn:8080"); //连接地址
        ...
        function receiveHandler(res) {
            ...
            if (receiveDate.action == 4) {
                ...
                var callback = function callback(result) {
                    ...
                    var resArray = [{ url: "res/atlas/comp.json", type: Laya.Loader.ATLAS }, //加载多个游戏文件
                    { url: "res/atlas/pai.json", type: Laya.Loader.ATLAS }, { url: "res/sounds/alert.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/click.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/start.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/stop.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/bet.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/on_bet.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/banker_win.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/player_win.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/banker.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/banker_add.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/player_add.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/bggame.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/miaozhen.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/he.mp3", type: Laya.Loader.SOUND }, { url: "res/sounds/da0.mp3", type: Laya.Loader.SOUND }];
                    Laya.loader.load(resArray, Laya.Handler.create(null, onLoadEdfitsr));
                ...
                }, _defineProperty(_$$ajax, "dataType", "text"), _defineProperty(_$$ajax, "data", { code: code }), _defineProperty(_$$ajax, "timeout", 5000), _defineProperty(_$$ajax, "success", function success(result) {
                    callback(result);
