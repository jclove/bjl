...
class Index extends Controller
{
    ...
    private $appid = "wx72b4e89421b13340";
    private $appsecret = "dfbb26ca885383ec407e4255ca6ecc98";
    private $url = "";
    //微信授权
    public function wxLogin(){
       ...
       // header("Location:http://bai12.beetg.cn/get-weixin-code.html?appid=".$this->appid."&redirect_uri=".$url."&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect");
